...
import { initSearching } from "./components/searching.js"; // ← новый импорт
...
const sampleTable = initTable({
    tableTemplate: 'table',
    rowTemplate: 'row',
    before: ['search', 'header', 'filter'],  // ← 'search' идёт первым
    after: ['pagination']
}, render);

// @todo: инициализация
const applySearching = initSearching('search'); // ← имя поля поиска из формы
